...
Stage.prototype.action = function(time, player, enemies, turrets, GUI, powerups){
    ...
    if ((this.newWave && (this.timeWave < this.game.time.now)) 
		...
		if(this.newWave){
			...
			if (this.waveCount === 5) {
				var mioDiv = document.getElementById("mio");
				mioDiv.innerHTML  = "Félicitations! Entrez le code <b>" + "bluestone" + "</b> <a href='https://jobine.io/app/settings'>ici</a> pour recevoir votre badge!";
			}
